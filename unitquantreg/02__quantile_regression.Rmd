...
- Assuming that $\mu_i = \boldsymbol{x}_i^\top \boldsymbol{\beta}(\tau)$ for a given 
quantile $\tau \in (0,1)$.
...
- `r Citet(myBib, "Kozumi2011")` proposed the following a mixture representation of AL
distribution:
...
where $\theta = \dfrac{1 - 2 \tau}{\tau (1 - \tau)}$ e $\varphi^2=\dfrac{2}{\tau (1 - \tau)}$.
